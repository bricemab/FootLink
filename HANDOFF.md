...
52. **Annonces (Phase 5) — module complet** (25 juillet 2026). Le modele `Listing` existait deja en base ; il manquait tout le reste. Six routes sous `/listings`, un ordonnanceur, et les ecrans dans l'equipe.
    ...
    - **Les annonces ne sont PAS un onglet** : une annonce appartient a une equipe, un onglet global redemanderait « laquelle ? » a chaque creation. Elles vivent dans `club/listings/` (pile masquee par `href: null`), atteintes depuis le detail de l'equipe.
